...
void gInitAnalogADC(void)
{
	...
	ADC_RegularChannelConfig(ADC_USED,SENSOR_CHANNEL_3,SENSOR_CHANNEL_3_INDEX,ADC_SampleTime_41Cycles5 );
	ADC_RegularChannelConfig(ADC_USED,SENSOR_CHANNEL_2,SENSOR_CHANNEL_2_INDEX,ADC_SampleTime_41Cycles5 );
	ADC_RegularChannelConfig(ADC_USED,SENSOR_CHANNEL_1,SENSOR_CHANNEL_1_INDEX,ADC_SampleTime_41Cycles5 );
